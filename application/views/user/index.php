<div class="container mt-5">
  <br><center><h2>Laporkan Pengaduan, Aspirasi, Pertanyaan Anda Disini</h2></center><br>
  <table align="center" >
    <tr>
      <td align="center">
    ...
    <tr>
      <td align="center">User / Pengguna Melaporkan Laporan Melalui form Laporan</td>
      <td align="center">Petugas Memvalidasi Laporan Maksimal</td>
      <td align="center">Laporan Sedang Dikerjakan Oleh Pelaksana</td>
      <td align="center">Pelaksana Memberikan Tanggapan Beserta Bukti Penyelesaiannya</td>
      <td align="center">Masyrakat Bisa Memilih Untuk Melanjutkan Pertanyaan, atau Menyelesaikan Laporan (1 kali kesempatan)</td>
      <td align="center">Laporan Anda Selesai</td>
    </tr>
  </table>
  <br>
</div>
  <div class="container">
    <div class="row mt-5 mb-5">
      <div class="col mb-5 mt-5">
        <h3><center>Anda Telah Membuat <?= $jumlah_data; ?> Laporan</center></h3>
        ...
        <table id="datatables" class="table table-bordered mt-5" style="width: 90%;">
          ...
          <?php foreach($pengaduan as $pgd): ?>
            <tr>
              ...
              <td>
                <a class="btn btn-primary" href="<?= base_url(); ?>anggota/detailpengaduan/<?= $pgd['id_pengaduan'] ?>" class="tombol">Detail</a><br>
              </td>
            </tr>
            <?php endforeach; ?> 
          </tbody>
