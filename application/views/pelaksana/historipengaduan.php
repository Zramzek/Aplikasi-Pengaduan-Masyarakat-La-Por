<div class="container">
    <div class="row mt-5 mb-5">
      <div class="col mb-5 mt-5">
        <h3><center>Daftar Laporan <?= $pelaksana['bidang'];?></center></h3>
        ...
        <table id="datatables" class="table table-bordered mt-5" style="width: 90%;">
          ...
          <?php foreach($pengaduan as $pgd): ?>
            <tr>
              ...
              <td>
                <a class="btn btn-primary" href="<?= base_url(); ?>pelaksana/detailhistori/<?= $pgd['id_pengaduan'] ?>" class="tombol">Detail</a><br>
              </td>
            </tr>
            <?php endforeach; ?> 
          </tbody>
